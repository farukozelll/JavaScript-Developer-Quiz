...
function checkAnswer(userAnswer, tag, n) {
  ...
  if (cA == 0) {
    if (userAnswer == data[n].answer) {
      ...
      tag.style.color = "#fff";
      tag.getElementsByTagName("i")[0].innerHTML += "<i>Doğru</i>";
      cA++;
      ...
      tag.style.color = "#fff";
      tag.getElementsByTagName("i")[0].innerHTML += "<i>Yanlış</i>";

      corectTag = tag.parentElement.getElementsByTagName("li")[
        data[n].answer - 1
      ];
      corectTag.getElementsByTagName("i")[0].innerHTML += "<i>Doğru</i>";
